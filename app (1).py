...
@app.route('/predict') # rendering the html templatey
def index() :
...
def predict():
    ...
    if (prediction == 1):
        return render_template('index.html', prediction='You have a liver desease problem, You must and should consult a doctor. Take care')
    else:
        return render_template('index.html', prediction='You dont have a liver desease problem')
